...
const STREAM: Obs[] = [
  {
    id: "o1", category: "layout", sectionId: "sec_1", confidence: 0.90,
    claim: "Sticky top nav: logo left-aligned, primary links centered, sign-in + CTA right",
  },
  {
    id: "o2", category: "layout", sectionId: "sec_1", confidence: 0.90,
    claim: "Hero: full-bleed image, overlaid event title, date string, and dual-action CTA row",
  },
  {
    id: "o3", category: "motion", sectionId: "sec_2", confidence: 0.78,
    claim: "Horizontal carousel advances on arrow click — 4 cards visible, left/right controls",
  },
  {
    id: "o4", category: "layout", sectionId: "sec_2", confidence: 0.90,
    claim: "3-column content grid: image thumbnail, category label, headline, short description",
  },
  {
    id: "o5", category: "motion", sectionId: "sec_1", confidence: 0.72,
    claim: "Scroll-triggered fade-in on section entry; no looping or ambient animations detected",
  },
  {
    id: "o6", category: "layout", sectionId: "sec_3", confidence: 0.90,
    claim: "Footer: 3-column link structure, newsletter subscribe form, social icons, copyright",
  },
  {
    id: "o7", category: "temporal", sectionId: "sec_0", confidence: 0.85,
    claim: "Page traversed top-to-bottom over ~12 s; no modals, back-navigation, or hover dwell",
  },
];
